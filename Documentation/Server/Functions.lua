...
GetObjectDamageReduction(aIndex,Type) //DAMAGE_REDUCTION_EXCELLENT_ITEM = 0, //DAMAGE_REDUCTION_SET_ITEM = 1, //DAMAGE_REDUCTION_JOH_ITEM = 2, //DAMAGE_REDUCTION_380_ITEM = 3, //DAMAGE_REDUCTION_MASTER_SKILL_TREE = 4, //DAMAGE_REDUCTION_SOCKET_ITEM = 5,
GetObjectShieldDamageReduction(aIndex)
GetObjectShieldGaugeRate(aIndex)
GetObjectDecreaseShieldGaugeRate(aIndex)
GetObjectIgnoreDefenseRate(aIndex)
GetObjectAddIgnoreDefenseRate(aIndex)
GetObjectIgnoreShieldGaugeRate(aIndex)
GetObjectDamagePvP(aIndex)
GetObjectDefensePvP(aIndex)
GetObjectResistIgnoreDefenseRate(aIndex)
GetObjectResistIgnoreShieldGaugeRate(aIndex)
GetObjectResistStunRate(aIndex)
GetObjectResistance(aIndex,Type) // ICE = 0 // POISON = 1 // LIGHTNING = 2 // FIRE = 3 // EARTH = 4 // WIND = 5// WATER = 6
GetObjectAddResistance(aIndex,Type) // ICE = 0 // POISON = 1 // LIGHTNING = 2 // FIRE = 3 // EARTH = 4 // WIND = 5// WATER = 6
GetObjectDefensiveFullHPRestoreRate(aIndex)
GetObjectDefensiveFullSDRestoreRate(aIndex)
GetObjectDefensiveFullMPRestoreRate(aIndex)
GetObjectOffensiveFullHPRestoreRate(aIndex)
GetObjectOffensiveFullSDRestoreRate(aIndex)
GetObjectOffensiveFullMPRestoreRate(aIndex)
GetObjectHPRecoveryRate(aIndex)
GetObjectMPRecoveryRate(aIndex)
GetObjectSDRecoveryRate(aIndex)
GetObjectHPRecovery(aIndex)
GetObjectMPRecovery(aIndex)
GetObjectSDRecovery(aIndex)
GetObjectDamageReflect(aIndex)
GetObjectCriticalDamageRate(aIndex)
GetObjectResistCriticalDamageRate(aIndex)
GetObjectExcellentDamageRate(aIndex)
GetObjectResistExcellentDamageRate(aIndex)
GetObjectDoubleDamage(aIndex)
GetObjectResistDoubleDamage(aIndex)
GetObjectTripleDamage(aIndex)
...
SetObjectShieldGaugeRate(aIndex,Value)
SetObjectDecreaseShieldGaugeRate(aIndex,Value)
SetObjectIgnoreDefenseRate(aIndex,Value)
SetObjectAddIgnoreDefenseRate(aIndex,Value)
SetObjectIgnoreShieldGaugeRate(aIndex,Value)
SetObjectDamagePvP(aIndex,Value)
SetObjectDefensePvP(aIndex,Value)
SetObjectResistIgnoreDefenseRate(aIndex,Value)
SetObjectResistIgnoreShieldGaugeRate(aIndex,Value)
SetObjectResistStunRate(aIndex,Value)
SetObjectResistance(aIndex,Type,Value) // ICE = 0 // POISON = 1 // LIGHTNING = 2 // FIRE = 3 // EARTH = 4 // WIND = 5// WATER = 6
SetObjectAddResistance(aIndex,Type,Value) // ICE = 0 // POISON = 1 // LIGHTNING = 2 // FIRE = 3 // EARTH = 4 // WIND = 5// WATER = 6
SetObjectDefensiveFullHPRestoreRate(aIndex,Value)
SetObjectDefensiveFullSDRestoreRate(aIndex,Value)
SetObjectDefensiveFullMPRestoreRate(aIndex,Value)
SetObjectOffensiveFullHPRestoreRate(aIndex,Value)
SetObjectOffensiveFullSDRestoreRate(aIndex,Value)
SetObjectOffensiveFullMPRestoreRate(aIndex,Value)
SetObjectHPRecoveryRate(aIndex,Value)
SetObjectMPRecoveryRate(aIndex,Value)
SetObjectSDRecoveryRate(aIndex,Value)
SetObjectHPRecovery(aIndex,Value)
SetObjectMPRecovery(aIndex,Value)
SetObjectSDRecovery(aIndex,Value)
SetObjectDamageReflect(aIndex,Value)
SetObjectCriticalDamageRate(aIndex,Value)
SetObjectResistCriticalDamageRate(aIndex,Value)
SetObjectExcellentDamageRate(aIndex,Value)
SetObjectResistExcellentDamageRate(aIndex,Value)
SetObjectDoubleDamage(aIndex,Value)
SetObjectResistDoubleDamage(aIndex,Value)
SetObjectTripleDamage(aIndex,Value)
